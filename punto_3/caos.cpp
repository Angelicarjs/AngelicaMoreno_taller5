...
double derivada_p2(double e, double q1, double q2){
	double d = q1-q2;				
	double f = (d*d)+((e*e)/4.0);
	double g = d/(pow(f,(3/2)));
	double h = q1+q2;
	double i = h*h+((e*e)/4.0);
 	double k = h/(pow(h,(3/2)));
	return g-k;
}
...
for(float i = 0; i < 3000/delta_t; i++){
	...
	double cte_p1_1 = derivada_p1(e, q1_O);
	double cte_p1_2 = derivada_p1(e, q1_O + (delta_t*0.5*cte_p1_1) );
	double cte_p1_3 = derivada_p1(e, q1_O + (delta_t*0.5*cte_p1_2) );
	double cte_p1_4 = derivada_p1(e, q1_O + (delta_t*cte_p1_3) );

	//Halla las constantes para p2
	double cte_p2_1 = derivada_p2(e, q1_O, q2_O);
	double cte_p2_2 = derivada_p2(e, q1_O + (delta_t*0.5*cte_p2_1), q2_O + (delta_t*0.5*cte_p2_1));
	double cte_p2_3 = derivada_p2(e, q1_O + (delta_t*0.5*cte_p2_2), q2_O + (delta_t*0.5*cte_p2_2));
	double cte_p2_4 = derivada_p2(e, q1_O + (delta_t*cte_p2_3), p2_O + (delta_t*cte_p2_3));
